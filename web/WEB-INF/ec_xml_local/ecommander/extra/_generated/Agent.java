    ...
    extends Item
{
    ...
    public void set_refuzed(Byte value) {
        setValue("refuzed", value);
    }

    public void setUI_refuzed(String value)
        throws Exception
    {
        setValueUI("refuzed", value);
    }

    public Byte get_refuzed() {
        return getByteValue("refuzed");
    }

    public Byte getDefault_refuzed(Byte defaultVal) {
        return getByteValue("refuzed", defaultVal);
    }

    public boolean contains_refuzed(Byte value) {
        return containsValue("refuzed", value);
    }
