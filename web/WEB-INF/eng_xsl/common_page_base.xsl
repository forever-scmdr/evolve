...
<xsl:stylesheet
	...
	<xsl:template name="TITLE">Sanatorium «Sputnik»</xsl:template>
			...
			<div class="top" style="position: relative; z-index: 100;">
				<div class="w1k">
					...
					<div class="item phones">
						...
						<span class="javascript show">All phones</span>
					...
					<div class="item docs">
						<a href="about/dogovory_/">Download contracts</a>
					</div>
					<div class="item mail">
						...
						<a href="#" id="mail" onclick="return false;">Write to us</a>
						<a href="mailto:info@sansputnik.by">info@sansputnik.by</a>
						<div class="hidden2 mail">
							<div class="close">
								<img src="images/button_close.png" alt="Close" />
							</div>
							<div class="send">
								<h3>
									<img src="images/title_soobschenie.png" alt="message" />
								</h3>
								<form id="feedback_form" action="email.item" method="post">
									...
									<a class="submit" href="javascript:postForm()">Submit</a>
								</form>
							</div>
							<div class="msg_ok">
								<img src="images/title_soobschenie_otpr.png" alt="сообщение отправлено" />
								<a href="#" id="one_more" onclick="return postMore()">Write another message</a>
							</div>
						</div>
					</div>
					<div class="item map">
			...
			<div class="menu">
				<table style="width: 100%;">
					<tr>
						...
						<td style="width:960px; position: relative;" id="td-f">
							
							<ul class="main" id="main-menu">
								<li class="about lnk has_sub">
									<a href="{/page/about/abstract_page[1]/show_page}" class="lvl1">About us</a>
								...
								<li class="lnk">
									<a class="lvl1" href="{/page/rooms_link}">Rooms</a>
								</li>
								...
								<li class="lnk">
									<a style="line-height:19px; height: 30px; padding: 13px 30px 12px; text-decoration: none;" class="lvl1" href="{/page/book_link}">
										<span style=" text-decoration: underline;">Booking</span>
										<br />
										<span style="font-size: 12px; font-weight: normal;">(prices)</span>
									</a>
								</li>
								<li class="lnk">
									<a href="{/page/news_link}" class="lvl1">News</a>
								</li>
								<li class="lnk">
									<a href="{/page/contacts_link}" class="lvl1" style="">Contacts</a>
								</li>
							</ul>
							<div class="clear"></div>
							<a id="lang-switch" style="background-image: url('images/lang-ru.png');" class="eng-link" href="http://sansputnik.by/" title="Русская версия"></a>
						</td>
						<td class="side">
	...
	<div class="footer">
		<div class="inner">
			<div class="weather" style="padding-top: 12px;">
				<span class="javascript" style="color: white; font-size: 14px; padding-bottom: 1px; display: inline; border-bottom: 1px solid white; cursor: pointer">weather forecast</span>
			...
			<div class="curs" style="padding-top: 12px;">
				<span class="javascript" style="color: white; font-size: 14px; padding-bottom: 1px; display: inline; border-bottom: 1px solid white; cursor: pointer">Exchange rates</span>
				<div class="hidden" style="overflow: hidden; height: 123px; margin-top: -149px; padding: 0px;">
			...
			<table border="0" class="logo">
					<tr >
						...
						<td><a href="http://forever.by/">Developed by<br/>Forever web design studio</a></td>
					</tr>
			</table>
		</div>
	</div>
