				...
				<td align="center" style="background-color: #E6E6E6;">
					<div style="max-width: 600px; width: 600px; margin: auto; background-color: #fff; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 13px;">
						...
						<table cellspacing="0" cellpadding="0" width="600" style="background-color: #2F2F2F; color: #939393;">
							<tr>
								<td width="380" style="width: 380px; vertical-align: top; padding: 0 15px 30px;">224014 Республика Беларусь, г.&nbsp;Брест, ул.&nbsp;Писателя Смирнова, 168</td>
								<td width="220" style="width: 220px; vertical-align: top; padding: 0 15px; text-align: right;">
									<a href="https://termobrest.ru"><img src="img/SP.png" alt=""/></a> &nbsp;
									<a href="https://www.youtube.com/channel/UC0gvt4On84SIDHkMO4Y85cA"><img src="img/YouTube.png" alt=""/></a> &nbsp;
									<a href="https://www.facebook.com/termobrest.ru/"><img src="img/FB.png" alt=""/></a> &nbsp;
									<a href="https://www.instagram.com/termobrest.ru/"><img src="img/Instagram.png" alt=""/></a> &nbsp;
									<a href="https://vk.com/termobrest"><img src="img/VK.png" alt=""/></a>
								</td>
							</tr>
						</table>
