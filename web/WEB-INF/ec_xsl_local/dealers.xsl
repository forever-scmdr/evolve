						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="other">
								<div class="row">
									<div class="col-xs-12 switch-region">
										<button class="btn btn-info btn-xs" data-toggle="modal" 
											data-target="#region_{page/region[name='Западная Европа']/@id}" rel="Западная Европа">Западная Европа</button><xsl:text> </xsl:text>
										<button class="btn btn-info btn-xs" data-toggle="modal" 
...
<xsl:template name="POPUPS">
	...
	<xsl:apply-templates select="page/region[name='Западная Европа']"/>
