...
<xsl:text disable-output-escaping="yes">&lt;!DOCTYPE html&gt;</xsl:text>
	...
	<head>
		<meta charset="utf-8" />
		<base href="{page/base}" />
		<link rel="canonical" href="{page/base}/{if(page/@name != 'i-index') then page/$canonical else ''}" />
	...
	<body style="background: #fff; padding-top: 0;">
		<div id="contentWrapp" style="padding:0; margin:0;">
		...
		<script type="text/javascript" src="{page/base}/js/postmessage.js"></script>
		<script type="text/javascript" src="{page/base}/js/iframe-script.js"></script>
		<script>
