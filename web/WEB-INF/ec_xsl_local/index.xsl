...
<xsl:stylesheet
	...
	<xsl:variable name="title" select="'производство запорной и запорно-регулирующей арматуры. Электромагнитные газовые клапаны, заслонки регулирующие, фильтры газовые, блоки электромагнитных клапанов, приборы автоматики безопасности (датчики-реле давления ДРД)'"/>
