		...
		<div class="cart-list">
			<div class="cart-list__item cart-item">
				...
				<div class="cart-item__info">
					<a class="cart-item__name">НАВЕСНАЯ МЕХАНИЧЕСКАЯ СЕЯЛКА POZNANIAK 550</a>
					<div class="cart-item__artnumber">Артикул: <xsl:value-of select="1245662" /></div>
				</div>
				<div class="cart-item__price">
					<span class="text-label">Сумма</span>
					<span>12 456 EUR</span>
				</div>
				...
				<div class="extra-values" style="background: #fff;padding:0;">
					...
					<div class="cart-list__item cart-item" style="padding:0; border:0 none; border-bottom: 1px solid #ccc; margin-bottom:0;">
						...
						<div class="cart-item__info">
							<a class="cart-item__name">Деталь 1 опциональная 550</a><br/>
							<div class="cart-item__artnumber">Артикул: 1245</div>
						</div>
						<div class="cart-item__price">
					...
					<div class="cart-list__item cart-item" style="padding:0; border:0 none; border-bottom: 1px solid #ccc; margin-bottom:0; ">
						<div class="cart-item__image"></div>
						<div class="cart-item__info">
							<a class="cart-item__name">Деталь 2 опциональная 550</a><br/>
							<div class="cart-item__artnumber">Артикул: 1245</div>
						</div>
						<div class="cart-item__price">
							<span class="text-label">Цена</span>
					...
					<div class="cart-list__item cart-item" style="padding:0; border:0 none; margin-bottom:0;">
						<div class="cart-item__image"></div>
						<div class="cart-item__info">
							<a class="cart-item__name">Деталь 3 опциональная 550</a><br/>
							<div class="cart-item__artnumber">Артикул: 1245</div>
						</div>
						<div class="cart-item__price">
							<span class="text-label">Цена</span>
