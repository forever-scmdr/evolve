...
<xsl:stylesheet
	...
	<xsl:variable name="title" select="'Деловые партнеры'"/>
	...
	<div class="container main-content">
		<div class="row">
			<div class="col-sm-4 col-md-3 hidden-xs side-coloumn">
				<h1 class="no-top-margin">Деловые партнеры</h1>
				...
				<ul class="list-group side-menu">
					...
					<li class="list-group-item">
						<a href="{page/all_partners_link}" class="active-link">Деловые партнёры СП «ТермоБрест» ООО</a>
					</li>
				</ul>
			...
			<div class="col-xs-12 col-sm-8 col-md-9">
				<div class="row">
					<div class="col-xs-12">
						...
						<h2 class="no-top-margin">Деловые партнеры СП «ТермоБрест» ООО</h2>
					</div>
				</div>
							...
							<div class="panel panel-default">
								...
								<div id="collapseRus" class="panel-collapse collapse" role="tabpanel">
									<div class="panel-body">
										<xsl:for-each select="//region[contains(name, 'ФО') and dealer/is_partner = 'да']">
											<xsl:apply-templates select="dealer[is_partner = 'да']" />
										</xsl:for-each>
									</div>
								</div>
							</div>
							<xsl:for-each select="//region[not(contains(name, 'ФО')) and name != 'Китай' and dealer/is_partner = 'да']">
