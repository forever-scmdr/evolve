			...
			<div class="product-info">
				...
				<xsl:if test="not($has_lines)">
					<div class="device-page__actions">
						<div class="device__in-stock device__in-stock_no"><i class="far fa-clock"></i>Товара сейчас нет в наличии</div>
						<div class="extra-links">
							<p>Вы можете найти похожий товар, нажав на кнопку ниже:</p>
							<a href="{$p/search_link}">Найти похожий товар</a>
						</div>
					</div>
				</xsl:if>
