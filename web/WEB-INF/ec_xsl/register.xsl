	...
	<xsl:template name="CONTENT">
		...
		<div class="page-content m-t">
			...
			<ul class="nav nav-tabs" role="tablist">
				...
				<li role="presentation" class="{'active'[not($is_login)]}"><a href="#tab_jur" role="tab" data-toggle="tab">Юридическое лицо</a></li>
			...
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane{' active'[not($is_login)]}" id="tab_jur">
					<p>Заполните, пожалуйста, форму регистрации. Ваш email будет использован в качестве логина. Если не указан email, будет использован номер телефона.</p>
