...
<xsl:stylesheet
	...
	<xsl:variable name="title" select="concat($prod/name, ' - ', $prod/main_section/name)"/>
	...
	<div class="row">
		<div class="col-xs-12 col-md-6">
			<a href="#" data-toggle="modal" data-target="#q11-zoom">
				<img  onerror="this.src = 'images/noimage.png'" src="{$prod/@path}{$prod/img_small}" alt="{$prod/alt}" title="{$prod/alt}" style="max-width: 100%;" />
			</a>
		</div>
