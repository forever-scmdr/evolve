						...
						<tr>
							...
							<td colspan="2">
								...
								<xsl:if test="$country = 'bel'">
									<span class="denom">цена в рублях до деноминации</span>
								</xsl:if>
							</td>
							<td colspan="2">
				...
				<div>
					<table border="0">
						<tbody>
							<tr>
								<td style="text-align: center;">
									<a href="{page/room_search_link}"
										style="background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(18, 121, 18, 1) 0%, rgba(1, 96, 33, 1) 100%) repeat scroll 0 0;
											    border-radius: 5px;
											    color: #fff;
											    display: block;
											    font-size: 22px;
											    ...
											    width: 240px; margin-bottom: 12px;">Online-бронирование</a>
								</td>
							</tr>
						</tbody>
					</table>
...
<!-- 					</table> -->
	...
	<div class="common">
		...
		<div class="serv-sec">
			...
			<a class="menu rus {'open'[$pay_type = 'rus']}" href="{$pay_link_rus}" >Для иностранных граждан (RUR)</a>
			<a class="menu rus {'open'[$pay_type = 'eur']}" href="{$pay_link_eur}" >Для иностранных граждан (EUR)</a>
		</div>
