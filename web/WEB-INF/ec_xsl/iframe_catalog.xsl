...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns="http://www.w3.org/1999/xhtml" xmlns:f="f:f" version="2.0">
	...
	<xsl:variable name="new_devices" select="//new_devices" />
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<div class="well accent">
							<p>Номенклатура продукции марки ТЕРМОБРЕСТ составляет более 12 000
								...
								<div class="row">
									...
									<div class="col-md-5 col-sm-5 .col-xs-12">
										...
										<div class="title-container">
											...
											<a href="{replace($new_devices/link, 'sec', 'i-sec')}" class="btn btn-primary btn-md">Узнать больше</a>
										</div>
									</div>
									<div class="col-md-5 col-sm-5 .col-xs-12">
