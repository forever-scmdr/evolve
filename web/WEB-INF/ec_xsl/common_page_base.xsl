...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:f="f:f" version="2.0">
	...
	<xsl:template name="INC_DESKTOP_HEADER">
		...
		<section class="header desktop">
			<div class="container">
				<a href="{$main_host}" class="logo"><img src="img/logo.jpg" alt="" /></a>
		...
		<div class="header mobile">
			<div class="header-container">
				<a href="{$main_host}" class="logo">
					<img src="img/logo.jpg" alt="На главную страницу" style="height: 1.5em; max-width: 100%;"/>
				</a>
...
<!--		</div>-->
	...
	<xsl:template name="COMMON_LEFT_COLOUMN">
		...
		<div class="contacts">
			<div class="block-title block-title_normal">Скачать</div>
