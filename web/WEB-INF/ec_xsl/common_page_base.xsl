...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:f="f:f" version="2.0">
	...
	<xsl:variable name="title" select="'teximat.by'" />
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="header-container" style="position: relative;">
						<div class="logo">
							<a href="{$main_host}"><img src="img/logo_big.svg" alt="На главную страницу" /></a>
						</div>
						<div class="search">
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="footer-container">
							<div class="block">
								<p><strong>© Teximat.by, 2002-2021</strong></p>
								<div class="forever">
							...
							<div class="block">
								<div class="raiting-stars">
									<div class="stars" id="site_rating" itemscope="" itemtype="http://data-vocabulary.org/Review-aggregate">
										<span itemprop="itemreviewed">Наш рейтинг</span> 4.74 <br/>
											(Голосов: <span itemprop="votes">52</span>)
											<span itemprop="rating" itemscope="" itemtype="http://data-vocabulary.org/Rating">
											<meta itemprop="value" content="4.74"/>
	...
	<xsl:template match="accessory | set | probe | product | assoc">
		...
		<xsl:variable name="big" select="if(f:num(main_pic/@width) &gt; f:num(gallery[1]/@width)) then main_pic else gallery[1]"/>
		...
		<div class="catalog-item">
			...
			<xsl:if test="f:num($big/@width) &gt; 200">
				<a href="{concat(@path, $big)}" class="magnific_popup-image zoom-icon" title="{name}" rel="nofollow">
				...
				<div class="links">
					<div id="compare_list_{code}">
						<span>
							...
							<a href="{to_compare}" ajax="true" ajax-loader-id="compare_list_{code}" rel="nofollow">в сравнение</a>
						</span>
					</div>
					<xsl:choose>
						...
						<xsl:otherwise>
							<div id="fav_list_{code}">
								<span><i class="fas fa-star"></i> <a href="{to_fav}" ajax="true" ajax-loader-id="fav_list_{code}" rel="nofollow">в избранное</a></span>
							</div>
						</xsl:otherwise>
					</xsl:choose>
				</div>
