...
<xsl:stylesheet
	...
	xmlns:f="f:f"
	version="2.0">
	<xsl:import href="message_form.xsl" />
	<xsl:import href="callback_form.xsl" />
	<xsl:import href="currency_ajax.xsl" />
	<xsl:import href="stom_form.xsl" />
...
<!-- 		<xsl:value-of select="concat(number($parts[1]), ' ', $months[$month], ' ', $parts[3])"/> -->
	...
	<xsl:if test="not($pname = 'index')">
		...
		<!-- <div id="forever-banner-top-client_6" cid="6" class="forever-banner" style="text-align:center; background-color: #184922;">
			<img src="images/ss_new_year_banner.jpg" alt=""/>
		</div> -->
	</xsl:if>
	<nav class="navbar navbar-fixed-top{' scrolled'[not($pname = 'index')]}">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<ul class="extra-links">
				...
				<li><i class="fa fa-envelope"></i><a href="/quest">Анкета</a></li>
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<!-- <li><a href="quest">Анкета гостя</a></li> -->
					</ul>
				</li>
	...
	<div class="social-icons">
		<div><a href="https://vk.com/asbsansputnik" target="_blank"><i class="fa fa-vk fa-2x"></i></a></div>
		<div><a href="https://twitter.com/SanSputnik" target="_blank"><i class="fa fa-twitter fa-2x"></i></a></div>
		<div><a href="https://www.instagram.com/asbsansputnik/" target="_blank"><i class="fa fa-instagram fa-2x"></i></a></div>
		<div><a href="https://www.facebook.com/asbsansput/" target="_blank"><i class="fa fa-facebook fa-2x"></i></a></div>
		<div><a href="https://www.youtube.com/channel/UCWPgHBYsffCrjjD3onQGpog" target="_blank"><i class="fa fa-youtube fa-2x"></i></a></div>
		<div><a href="https://ok.ru/sansputnik" target="_blank"><i class="fa fa-odnoklassniki fa-2x"></i></a></div>
	</div>
	</xsl:template>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 p-b-small">
					<form id="serch" action="{page/search_link}" method="get">
					...
					<div class="forever">
							...
							<a href="https://forever.by" style="color: #fff;"> Разработка сайта - 
							студия веб-дизайна Forever</a>
	...
	<div class="dim-block" style="display: none;" id="booking-online">
		...
		<div class="center">
			...
			если вы хотите оформить бронь для граждан разных государств свяжитесь с нашими менеджерами по телефону: +375 (1797) 28-888.</p>
		...
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<p>Для бронирования номера свяжитесь с нами по телефону <strong>+375(1797) 28-888.</strong></p>
				</div>
			</div>
		</div>
	</div>
	...
	<xsl:template match="*" mode="pagination">
		<div class="pages">
			Старница: <xsl:apply-templates select="current_page | page"/>
		</div>
	</xsl:template>
