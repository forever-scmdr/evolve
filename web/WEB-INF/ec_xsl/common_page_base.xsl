					...
					<div class="col-xs-12">
						<div class="footer-container">
							...
							<div class="block">
								...
								<a href="https://efind.ru" title="Поиск электронных компонентов">
									<img src="//static.efind.ru/img/b/88x31.gif" style="border: 0px solid"
...
<!--		<xsl:variable name="product_link" select="concat($sel_sec_link, substring(show_product, 1))"/>-->
		...
		<div class="device items-catalog__device">
			...
			<xsl:if test="manual and not(manual = '')">
