			...
			<div class="price_room">
				...
				<table style="background-color: #ffff99">
					<tr>
						...
						<td colspan="3">Стоимость за первый интервал</td>
						<td colspan="3">Стоимость за второй интервал</td>
						<td colspan="3">Стоимость за третий интервал</td>
					</tr>
					<tr>
						<td colspan="3">
					...
					<xsl:for-each select="$rooms/room">
						<tr><td colspan="11" style="background-color: white; padding-top: 3px; padding-bottom: 3px"></td></tr>
						<tr style="background-color: #cceeff">
							...
							<td>
								<input type="text" value="{price_san_eur_first}" name="{price_san_eur_first_inp}" class="pinp psan"/>
							</td>
							...
							<td>
								<input type="text" value="{price_san_eur_second}" name="{price_san_eur_second_inp}" class="pinp psan"/>
							</td>
							...
							<td>
								<input type="text" value="{price_san_eur_third}" name="{price_san_eur_third_inp}" class="pinp psan"/>
							</td>
						...
						<tr style="background-color: #80d4ff">
							...
							<td>
								<input type="text" value="{price_ozd_eur_first}" name="{price_ozd_eur_first_inp}" class="pinp pozd"/>
							</td>
							...
							<td>
								<input type="text" value="{price_ozd_eur_second}" name="{price_ozd_eur_second_inp}" class="pinp pozd"/>
							</td>
							...
							<td>
								<input type="text" value="{price_ozd_eur_third}" name="{price_ozd_eur_third_inp}" class="pinp pozd"/>
							</td>
						</tr>
					</xsl:for-each>
				</table>
...
<!-- 					<xsl:call-template name="HEADER" /> -->
					<div class="mainwrap" style="width: 1600px;">
