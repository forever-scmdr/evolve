...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="/">
		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<h1>
					<xsl:value-of select="/page/operation"/>
				</h1>
				...
				<table>
					<tr>
						...
						<td class="error">
							...
							<xsl:value-of select="/page/total-line-number"/>
						</td>
					</tr>
					<tr>
						<td>Всего элементов для обработки:</td>
						<td class="error">
							<xsl:value-of select="/page/to_process"/>
						</td>
					</tr>
					<tr>
						<td>Элементов обработано:</td>
						<td class="error">
							<xsl:value-of select="/page/processed"/>
						</td>
					</tr>
					<tr>
						<td>Проиндексировано товаров:</td>
						<td class="error">
							<xsl:value-of select="/page/items-indexed"/>
						</td>
					</tr>
					<tr>
						<td colspan="2" align="center">
							<b>Хронология интеграции</b>
						</td>
					</tr>
