<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:f="f:f" version="2.0">
	...
	<xsl:template name="USER_PHYS_INPUTS">
		...
		<xsl:if test="page/@name != 'register'">
			<div class="form__item"><label class="form-label" for="form_ship">Способ доставки: <a href="https://radiomarket-mozyr.by/oplata_i_dostavka/">подробнее</a></label>
			...
			<div class="form__item"><label class="form-label" for="form_pay">Способ оплаты: <a href="https://radiomarket-mozyr.by/oplata_i_dostavka/">подробнее</a></label>
