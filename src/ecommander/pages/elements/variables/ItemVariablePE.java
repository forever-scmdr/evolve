...
/**
 * Получает значение из текущего айтема бандла, который обозначен itemPageId
 * 
 ...
 * TODO <usability> сделать проверку на существование страничного атйема с ID itemPageId
 * @author E
 */
public class ItemVariablePE extends VariablePE {
	...
	public List<String> outputArray() {
		if (valuesCache == null) {
			...
			AllFoundIterator iter = getPageItem().getAllFoundItemIterator();
			while (iter.next())
