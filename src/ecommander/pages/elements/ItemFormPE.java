...
public class ItemFormPE extends PageElementContainer {
	...
	public ItemFormPE(String itemName, String pageItemId, String pageItemParentId, String restoreVar) {
	...
	private ItemFormPE(String itemName, String pageItemParentId, String pageItemId, String tag, String restoreVar) {
		this.itemName = itemName;
		this.parentItemPageId = pageItemParentId;
		this.itemPageId = pageItemId;
		this.tag = tag;
	...
	protected PageElementContainer createExecutableShallowClone(PageElementContainer container, ExecutablePagePE parentPage) {
		ItemFormPE clone = new ItemFormPE(itemName, parentItemPageId, itemPageId, tag, restoreVarName);
