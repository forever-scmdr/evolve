...
public final class FilterSQLCreator implements FilterCriteria, ItemQuery.Const {
	...
	// Критерии параметров ассоцированных айтемов (parent, child).
	// Сами критерии хранятся в соответствюущих группах критериев, главной или опциях.
	// Здесь хранится текущая ассоциация (parent, child), в которую добавляются сами критерии. Полкольку ассоциации
