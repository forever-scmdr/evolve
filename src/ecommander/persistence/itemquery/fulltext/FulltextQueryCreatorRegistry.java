...
public class FulltextQueryCreatorRegistry {
	...
	public static final String EQUAL = "equal"; // полное совпадение слов (возможна только перестановка местами)
	public static final String WILDCARD = "wildcard"; // полное включение запроса в часть слова результата
