    ...
    extends Item
{
    ...
    public void set_discount(String value) {
        setValue("discount", value);
    }

    public String get_discount() {
        return getStringValue("discount");
    }

    public String getDefault_discount(String defaultVal) {
        return getStringValue("discount", defaultVal);
    }

    public boolean contains_discount(String value) {
