...
public class MakeExcelPrice extends Command {
	...
	public ResultPE execute() throws Exception {
		...
		res.setVariable("file_name", "pricelist.xls");
		res.setVariable("file_caption", "Прайс-лист "+DATE_FORMAT.format(new Date())+".xls");
		res.setVariable("h1", "Создание прайс-листа завершено успешно");
