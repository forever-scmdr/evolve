...
import ecommander.pages.elements.ItemRootType;
...
import ecommander.pages.elements.ReferencePE;
...
import ecommander.pages.elements.filter.FilterCriteriaPE;
import ecommander.pages.elements.filter.FilterPE;
import ecommander.pages.elements.filter.FulltextCriteriaPE;
import ecommander.pages.elements.variables.CookieStaticVariablePE;
import ecommander.pages.elements.variables.ItemVariablePE;
import ecommander.pages.elements.variables.ParameterVariablePE;
...
import ecommander.pages.elements.variables.StaticItemVariablePE;
import ecommander.pages.elements.variables.StaticParameterVariablePE;
...
public class PageModelBuilder {
	...
	private ItemFormPE readForm(Element formNode, HashMap<String, Element> includes) throws PrimaryValidationException {
		...
		String id = formNode.getAttribute(ID_ATTRIBUTE);
		String restoreVar = formNode.getAttribute(RESTORE_VAR_ATTRIBUTE);
		ItemFormPE formElement = null;
		formElement = new ItemFormPE(itemName, itemId, parentId, id, restoreVar);
