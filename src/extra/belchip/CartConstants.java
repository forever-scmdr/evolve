...
public interface CartConstants {
	...
	String JUR_LTM = "Извините, минимальная сумма заказа для юридических лиц - %.2f руб. Заказ не может быть отправлен.";
	String PHYS_LTM = "Извините, минимальная сумма заказа для физических лиц - %.2f руб. Заказ не может быть отправлен.";
	String POST_LTM = "Извините, минимальная сумма заказа при отправке почтой - %.2f руб. Заказ не отправлен.";
	String LTM = "Извините, минимальная сумма заказа для физических лиц - %.2f руб., для юридических лиц - %.2f руб. Заказ не может быть отправлен.";
