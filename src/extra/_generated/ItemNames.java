...
public interface ItemNames {
    ...
    public interface bought_ {
        ...
        String SUM = "sum";
        String SUM_RUB = "sum_RUB";
        String SUM_USD = "sum_USD";
        String SUM_EUR = "sum_EUR";
    ...
    public interface catalog_ {
        ...
        String DATE = "date";
        String DELETE_LIST = "delete_list";
    ...
    public interface manual_ {

        String _ITEM_NAME = "manual";
        String NAME = "name";
        String LINK = "link";
    ...
    public interface section_ {
        ...
        String FILTER_SHOW_PARAMS = "filter_show_params";
