    ...
    extends Item
{
    ...
    public final static String FILTER_SHOW_PARAMS = "filter_show_params";
    ...
    public void set_filter_show_params(String value) {
        setValue("filter_show_params", value);
    }

    public String get_filter_show_params() {
        return getStringValue("filter_show_params");
    }

    public String getDefault_filter_show_params(String defaultVal) {
        return getStringValue("filter_show_params", defaultVal);
    }

    public boolean contains_filter_show_params(String value) {
        return containsValue("filter_show_params", value);
    }
