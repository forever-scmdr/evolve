...
public class DeployParsedSingle extends IntegrateBase {
	...
	private Product deployParsed(Parse_item pi, Item parentSection) throws Exception {
		...
		Item product = ItemQuery.loadSingleItemByParamValue(Product._ITEM_TYPE_NAME, "code", code);
		if (product != null)
		...
		Product prod = Product.get(ItemUtils.newChildItem(Product._ITEM_TYPE_NAME, parentSection));
		prod.set_code(code);
